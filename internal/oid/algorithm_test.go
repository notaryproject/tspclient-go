...
func TestToSignatureAlgorithm(t *testing.T) {
	tests := []struct {
		...
		{"SHA256WithRSAPSS", SHA256, RSAPSS, x509.SHA256WithRSAPSS},
		{"SHA384WithRSAPSS", SHA384, RSAPSS, x509.SHA384WithRSAPSS},
		{"SHA512WithRSAPSS", SHA512, RSAPSS, x509.SHA512WithRSAPSS},
